...
fetch('https://jsonplaceholder.typicode.com/todos')
    ...
    .then(function(todos) {
        ...
        todos.forEach(function(todo) {
            const todoObject = {
                text: todo.title, // Use the title from the API as the todo text
                completed: todo.completed // Use the completed status from the API
            };
            allTodos.push(todoObject); // Add the todo object to the allTodos array
        });
        updateTodoList(); // Update the todo list in the DOM
